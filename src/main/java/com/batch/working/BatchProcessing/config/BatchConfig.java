...
public class BatchConfig {
    ...
    @Bean
    public ItemWriter<Product> itemWrite(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Product>()
                .sql("Insert into products(product_id,title,description,price,discount,discounted_price)values(:productId,:title, " +
                        " :description,:price, :discount, :discountedPrice)")
